...
export type MotionState = { height: number; coyote: number; held: boolean; tap: number; flying: boolean; peak: number };
export type MotionAck = { state: MotionState; input: Input; ticks: number };
...
export type ServerMessage =
 ...
 | { type: 'snapshot'; players: Player[]; entities: Entity[]; time: number; weather: string; tick: number; motion?: MotionAck }
